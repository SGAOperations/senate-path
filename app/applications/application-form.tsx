...
const applicationSchema = z.object({
  ...
  communityConstituencyId: z.string().min(1, 'Please select your community constituency'),
  whySenateLongAnswer: z.string().min(50, 'Please provide a detailed response (at least 50 characters)'),
  constituencyIssueLongAnswer: z.string().min(50, 'Please provide a detailed response (at least 50 characters)'),
  diversityEquityInclusionLongAnswer: z.string().min(50, 'Please provide a detailed response (at least 50 characters)'),
  conflictSituationLongAnswer: z.string().min(50, 'Please provide a detailed response (at least 50 characters)'),
}).refine((data) => {
...
export default function ApplicationForm({ communityConstituencies }: ApplicationFormProps) {
            ...
            <div className="space-y-4 p-3 sm:p-6 rounded-lg bg-slate-50 border border-slate-200">
              ...
              <div className="space-y-2">
                ...
                <SearchableSelect
                  ...
                  onValueChange={(value) => {
                    setValue('communityConstituencyId', value, { shouldValidate: true });
                  }}
                ...
                {errors.communityConstituencyId && (
                  <p className="text-sm text-destructive">{errors.communityConstituencyId.message}</p>
                )}
                {communityConstituencies.length === 0 && (
                  <p className="text-sm text-muted-foreground">No community constituencies available</p>
                )}
              </div>
            </div>
